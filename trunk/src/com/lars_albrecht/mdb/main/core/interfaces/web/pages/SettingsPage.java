...
public class SettingsPage extends WebPage {
	...
	private String generateListSettingsView(final Template settingsTemplate) {
		...
		Integer maxItemsForListPagingOption = maxItemsForListPagingOptionObj == null ? null : ((OptionsHandler
				.getOption("maxItemsForListPagingOption") instanceof String ? Integer.parseInt((String) OptionsHandler
				.getOption("maxItemsForListPagingOption")) : (Integer) OptionsHandler.getOption("maxItemsForListPagingOption")));
